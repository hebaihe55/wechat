...
namespace wechat.Controllers
{
    public class Xinghe1Controller : Controller
    {
        ...
        public ActionResult Index(string code)
        {
            ...
            //    try
            //    {
            //        var wu = db.Question.SingleOrDefault(w => w.openid.Equals(jd["openid"]));

            //        if (wu == null)
            //        {


            //            ViewBag.openid = jd["openid"].ToString();
            //            return View();
            //        }
            //        else
            //        {
            ...
            //else
            //{
            //    Response.Redirect("https://open.weixin.qq.com/connect/oauth2/authorize?appid=" + Utils.WeHelper.appid + "&redirect_uri=http://mvc.cjoy.cn/Xinghe1/index&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect");
            //}

            ViewBag.openid = "bbbbb";
            return View();
        }
